...
export default function Sidebar({ isOpen, onClose }) {
  ...
  const navItems = [
    ...
    { to: '/print-batches', label: 'Print Batches', icon: Printer },
  ...
  return (
    <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
      ...
      <div style={{
        ...
        <div>Port 5006 Verification Authority</div>
        <div style={{ marginTop: '2px', fontWeight: 600, color: 'var(--primary-600)' }}>v2.0 Multi-Event Active</div>
      </div>
    </aside>
  );
}
